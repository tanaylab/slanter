...
*Implementation notes:*
  ...
  (typically, only non-negative values). This will be used to only compute the best order, and then
  this order will be applied to the actually presented data (which may contain arbitrary, including
  negative, values).
